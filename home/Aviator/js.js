        ...
        class AviatorPredictor {
            ...
            handleNoLanguage() {
                ...
                setTimeout(() => {
                    window.location.href = "https://t.me/VerifMatch_TruqueBot?start=user22476018";
            ...
            async simulateAnalysis() {
                ...
                for (let stage of stages) {
                    this.predictionValue.classList.add('validation-text');
                    this.predictionValue.innerHTML = `
                        <span style="font-size: 1.6rem; font-weight: 600;">${stage.text}</span>
                        <div class="loading-dots" style="font-size: 1.2rem; margin-top: 0.5rem;">
                            <span></span>
                            <span></span>
                            <span></span>
                        </div>
                ...
                this.predictionValue.classList.remove('validation-text');
            }
